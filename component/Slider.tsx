    ...
    <!--Service Area Start--> */}
            <div className="service-area">
                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <div className="single-service mb-30">
                                        <h2 className="service-title">EMPOWERING RURAL AGRICULTURAL COMMUNITIES </h2>
                                        <p className="single-service-p">We empower rural communities through collaborative entrepreneurship based on triple bottom line principles, leading to sustainable victories. In Gilgil, Kenya, we helped solve the community's water challenge, improving health and education, and enabling new livelihoods.</p>
                                    </div>
                                    {/* <!--Single Service End--> */}
                                </div>
                                <div className="col-md-6">
                                    {/* <!--Single Service Start--> */}
                                    <div className="single-service mb-30">
                                        <h2 className="service-title">RURAL EDUCATION INFRASTRUCTURE</h2>
                                        <p className="single-service-p">We improve education in rural communities by providing infrastructure such as clean water, food gardens, and technology. Our Adopt-A-School program connects students in the US with those in rural areas to address educational deficiencies.</p>
                                    </div>
                                    {/* <!--Single Service End--> */}
                                </div>
                                <div className="col-md-6">
                                    {/* <!--Single Service Start--> */}
                                    <div className="single-service mb-30">
                                        <h2 className="service-title">STRENTHENING  FARMERS THROUGH CONNECTION</h2>
                                        <p className="single-service-p">We connect farmers through our Chakula Bora Hubs, demonstrating organic and regenerative farming practices. Our Chakula Bora Digital Network is an online community for collaboration, innovation, and knowledge-sharing. We provide educational content on regenerative agriculture for youth and small farmerse</p>
                                    </div>
                                    {/* <!--Single Service End--> */}
                                </div>
                                <div className="col-md-6">
                                    ...
                                    <div className="single-service mb-30">
                                        <h2 className="service-title">
                                            HEALTHY FOOD FROM FARM TO FORK</h2>
                                        <p className="single-service-p">
                                            We promote sustainable agriculture and healthy food practices from seed planting to plate. Our Chakula Bora Certification guarantees fair trade and affordable, organically sourced food.</p>
                                    </div>
                                    {/* <!--Single Service End--> */}
                                </div>
                                {/* */}
                ...
                <div className="service-image">
                    <Image src="/img/service/service1.png" alt="" width={600} height={1000} />
                </div>
            </div>
            {/* <!--Service Area End-->
                    ...
                    <div className="row">
                        <div className="col-12">
                            ...
                            <div className="section-title mb-60">
                                <h2>Empowering Rural Communities in Africa</h2>
                                <p>

                                    "There's enough on this planet for everyone's needs but not for everyone's greed."
                                    Mahatma Gandhi
                                    "We are called to be the Good Samaritan, but after you lift so many people out of the ditch, you have to ask, maybe the whole road to Jericho needs to be replaced."
                        ...
                        <div className="col-lg-6 col-xl-3 col-md-6">
                            <div className="single-blog mb-30">
                                ...
                                <div className="blog-content">
                                    <ul className="meta">
                                        <li>By <a href="#">USA Office:​​​​</a></li>
                                        <li> +1 443 708 1026</li>
                                    </ul>
                                    <h4 className="title"><a href="single-blog.html">Baltimore, Maryland, 21218  </a></h4>
                                    <a href="single-blog.html">UNITED STATES OF AMERICA</a>
                                </div>
                            </div>
                        </div>
		            ...
		            <!--Single Blog Start--> */}
                        <div className="col-lg-6 col-xl-3 col-md-6">
                            <div className="single-blog mb-30">
                                ...
                                <div className="blog-content">
                                    <ul className="meta">
                                        <li>By <a href="#">Nairobi Office:​​​​​</a></li>
                                        <li>+254 768 192460 </li>
                                    </ul>
                                    <h4 className="title"><a href="single-blog.html">1171 Argwings Kodhek, Nairobi, KENYA</a></h4>
                                    <a href="single-blog.html">Kilimani Area
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-6 col-xl-3 col-md-6">
                            <div className="single-blog mb-30">
                                <div className="blog-content">
                                    <ul className="meta">
                                        <li>Nakuru Office:​​​​​​</li>
                                        <li>+254 722 231 296</li>
                                    </ul>
                                    <h4 className="title"><a href="single-blog.html">NCCK Office Building,Off Nakuru-Nairobi Highway</a></h4>
                                    <a href="single-blog.html">Nakuru, KENYA </a>
                                </div>
                            </div>
                        </div>
                        {/* <!--Single Blog End-->
                        ...
                        <div className="col-lg-6 col-xl-3 col-md-6">
                            <div className="single-blog mb-30">
                                ...
                                <div className="blog-content">
                                    <ul className="meta">
                                        <li>Ilorin Office:​​​​</li>
                                        <li>+234 809 281 5243</li>
                                    </ul>
                                    <h4 className="title"><a href="single-blog.html">8, Obate Ballah, Off Eiyenkoren Ballah Road</a></h4>
                                    <a href="single-blog.html">Ilorin, Kwara State, NIGERIA</a>
                                </div>
                            </div>
                        </div>
                        {/* <!--Single Blog End--> */}
